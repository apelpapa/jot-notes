...
//Temp user for username. In future, import actual user and import User Type
const user = {
  name: 'Abel',
...
export default function FixedFooter() {
  ...
  return (
    <div className="fixed bottom-0 left-0 p-3 pb-1 w-full grid grid-cols-3 footer border-t-2">
      <label className="swap swap-rotate justify-self-start self-end">
      ...
      <p className="justify-self-center self-end font-semibold text-xl">Hello {user.name}</p>
    </div>
  );
}
